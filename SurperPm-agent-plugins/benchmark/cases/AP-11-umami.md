---
id: AP-11
title: Website analytics anomaly review
level: AP
track: B
target_repo_type: next-app
target_repo: ap-umami
...
oracle: |
  L2+ application task: Add an anomaly-review marker for tracked websites or reports, propagate it through server data access and dashboard UI, and provide a filter for unresolved anomalies.
...
# AP-11 Website analytics anomaly review

## Goal

在 `Analytics dashboard` 应用仓中完成一个 L2+ 级别的跨模块需求：Add an anomaly-review marker for tracked websites or reports, propagate it through server data access and dashboard UI, and provide a filter for unresolved anomalies.
