---
id: AP-39
title: Order risk review flag
level: AP
track: B
target_repo_type: django-app
target_repo: ap-django-oscar
...
oracle: |
  L2+ application task: Add an order risk-review flag through model/API/admin or dashboard surfaces, and preserve existing order pipeline semantics.
...
# AP-39 Order risk review flag

## Goal

在 `Commerce platform` 应用仓中完成一个 L2+ 级别的跨模块需求：Add an order risk-review flag through model/API/admin or dashboard surfaces, and preserve existing order pipeline semantics.
