---
id: AP-29
title: Article editorial readiness flow
level: AP
track: B
target_repo_type: rails-app
target_repo: ap-forem
...
oracle: |
  L2+ application task: Add editorial readiness metadata for posts/articles, surface it in author/admin views, and preserve published/draft behavior.
...
# AP-29 Article editorial readiness flow

## Goal

在 `Community publishing` 应用仓中完成一个 L2+ 级别的跨模块需求：Add editorial readiness metadata for posts/articles, surface it in author/admin views, and preserve published/draft behavior.
