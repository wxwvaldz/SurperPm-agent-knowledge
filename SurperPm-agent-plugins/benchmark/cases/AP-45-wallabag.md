---
id: AP-45
title: Article reading-priority workflow
level: AP
track: B
target_repo_type: symfony-app
target_repo: ap-wallabag
...
oracle: |
  L2+ application task: Add a reading-priority/review state for saved articles, expose it in filters/list/detail views, and preserve tagging/archive behavior.
...
# AP-45 Article reading-priority workflow

## Goal

在 `Read-it-later` 应用仓中完成一个 L2+ 级别的跨模块需求：Add a reading-priority/review state for saved articles, expose it in filters/list/detail views, and preserve tagging/archive behavior.
