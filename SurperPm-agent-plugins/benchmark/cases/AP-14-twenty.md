---
id: AP-14
title: CRM record stewardship workflow
level: AP
track: B
target_repo_type: fullstack-ts
target_repo: ap-twenty
...
oracle: |
  L2+ application task: Add record-stewardship metadata for companies/people, surface stale or unassigned stewardship in CRM list/detail views, and preserve existing role/permission behavior.
...
# AP-14 CRM record stewardship workflow

## Goal

在 `CRM` 应用仓中完成一个 L2+ 级别的跨模块需求：Add record-stewardship metadata for companies/people, surface stale or unassigned stewardship in CRM list/detail views, and preserve existing role/permission behavior.
