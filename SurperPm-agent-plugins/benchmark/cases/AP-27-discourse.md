---
id: AP-27
title: Topic policy review marker
level: AP
track: B
target_repo_type: rails-app
target_repo: ap-discourse
...
oracle: |
  L2+ application task: Add a policy-review marker for topics, show it in moderation/list views, and preserve trust-level and permission checks.
...
# AP-27 Topic policy review marker

## Goal

在 `Forum` 应用仓中完成一个 L2+ 级别的跨模块需求：Add a policy-review marker for topics, show it in moderation/list views, and preserve trust-level and permission checks.
