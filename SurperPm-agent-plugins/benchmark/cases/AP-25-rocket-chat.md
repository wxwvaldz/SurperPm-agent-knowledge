---
id: AP-25
title: Channel moderation review queue
level: AP
track: B
target_repo_type: node-react-app
target_repo: ap-rocket-chat
...
oracle: |
  L2+ application task: Add moderation-review metadata for channels or messages, expose it in list/detail/admin views, and avoid weakening existing room permissions.
...
# AP-25 Channel moderation review queue

## Goal

在 `Team chat` 应用仓中完成一个 L2+ 级别的跨模块需求：Add moderation-review metadata for channels or messages, expose it in list/detail/admin views, and avoid weakening existing room permissions.
