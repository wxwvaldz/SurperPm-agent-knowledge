---
id: AP-44
title: Task blocked-state review surface
level: AP
track: B
target_repo_type: php-app
target_repo: ap-kanboard
...
oracle: |
  L2+ application task: Add a blocked-state review marker for tasks, show it on board/list/detail views, and preserve swimlane/project permissions.
...
# AP-44 Task blocked-state review surface

## Goal

在 `Kanban` 应用仓中完成一个 L2+ 级别的跨模块需求：Add a blocked-state review marker for tasks, show it on board/list/detail views, and preserve swimlane/project permissions.
