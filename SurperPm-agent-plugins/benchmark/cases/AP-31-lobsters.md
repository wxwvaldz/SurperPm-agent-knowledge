---
id: AP-31
title: Story review and source quality signal
level: AP
track: B
target_repo_type: rails-app
target_repo: ap-lobsters
...
oracle: |
  L2+ application task: Add a source-quality review marker for submitted stories, display it in story/moderation views, and preserve voting/comment behavior.
...
# AP-31 Story review and source quality signal

## Goal

在 `Link aggregator` 应用仓中完成一个 L2+ 级别的跨模块需求：Add a source-quality review marker for submitted stories, display it in story/moderation views, and preserve voting/comment behavior.
