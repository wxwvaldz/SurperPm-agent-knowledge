---
id: AP-43
title: Contact follow-up review flow
level: AP
track: B
target_repo_type: laravel-app
target_repo: ap-monica
...
oracle: |
  L2+ application task: Add follow-up review metadata for contacts, expose overdue/unreviewed contacts in UI/API surfaces, and preserve existing relationship tracking.
...
# AP-43 Contact follow-up review flow

## Goal

在 `Personal CRM` 应用仓中完成一个 L2+ 级别的跨模块需求：Add follow-up review metadata for contacts, expose overdue/unreviewed contacts in UI/API surfaces, and preserve existing relationship tracking.
