---
id: AP-03
title: Memo review reminder surface
level: AP
track: B
target_repo_type: go-react-app
target_repo: ap-memos
...
oracle: |
  L2+ application task: Add a per-memo review reminder timestamp that appears in memo lists and detail/edit flows, supports filtering overdue reminders, and preserves markdown memo behavior.
...
# AP-03 Memo review reminder surface

## Goal

在 `Knowledge/memo app` 应用仓中完成一个 L2+ 级别的跨模块需求：Add a per-memo review reminder timestamp that appears in memo lists and detail/edit flows, supports filtering overdue reminders, and preserves markdown memo behavior.
