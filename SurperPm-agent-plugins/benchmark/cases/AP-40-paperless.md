---
id: AP-40
title: Document retention review queue
level: AP
track: B
target_repo_type: django-app
target_repo: ap-paperless
...
oracle: |
  L2+ application task: Add retention-review metadata for documents, surface it in search/list/detail views, and avoid changing OCR/import behavior.
...
# AP-40 Document retention review queue

## Goal

在 `Document management` 应用仓中完成一个 L2+ 级别的跨模块需求：Add retention-review metadata for documents, surface it in search/list/detail views, and avoid changing OCR/import behavior.
