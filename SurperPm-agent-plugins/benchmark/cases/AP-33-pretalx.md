---
id: AP-33
title: Proposal review conflict indicator
level: AP
track: B
target_repo_type: django-app
target_repo: ap-pretalx
...
oracle: |
  L2+ application task: Add a reviewer-conflict indicator for talk proposals, propagate it through review assignment UI/API, and preserve existing scoring workflows.
...
# AP-33 Proposal review conflict indicator

## Goal

在 `Conference management` 应用仓中完成一个 L2+ 级别的跨模块需求：Add a reviewer-conflict indicator for talk proposals, propagate it through review assignment UI/API, and preserve existing scoring workflows.
