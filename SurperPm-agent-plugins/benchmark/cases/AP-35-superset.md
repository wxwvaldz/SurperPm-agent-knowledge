---
id: AP-35
title: Dashboard certification review queue
level: AP
track: B
target_repo_type: python-react-app
target_repo: ap-superset
...
oracle: |
  L2+ application task: Add a certification-review marker for dashboards or charts, expose it in list/detail UI and API data, and preserve existing permission checks.
...
# AP-35 Dashboard certification review queue

## Goal

在 `BI dashboard` 应用仓中完成一个 L2+ 级别的跨模块需求：Add a certification-review marker for dashboards or charts, expose it in list/detail UI and API data, and preserve existing permission checks.
