...
`/SuperPmAgent-core:clarify` turns a raw PM request into a structured session IntentSpec under `knowledge/sessions/<session-name>/`.
...
- Creating or updating `knowledge/sessions/<session-name>/`.
